        ...
        <nav class="navegacion">
            <div class="flex items-center">
                <div class="space-x-1 border-r pr-4">
                    <a class="border-b border-solid border-transparent hover:border-white transition duration-300 py-2 px-4" href="{{route('main')}}">Home</a>
                    <a class="border-b border-solid border-transparent hover:border-white transition duration-300 py-2 px-4" href="{{route('videos.index')}}">Videos</a>
                    <a class="border-b border-solid border-transparent hover:border-white transition duration-300 py-2 px-4" href="{{route('categories.index')}}">Categories</a>
                    <a class="border-b border-solid border-transparent hover:border-white transition duration-300 py-2 px-4" href="{{route('memberships.index')}}">Memberships</a>
                </div>
