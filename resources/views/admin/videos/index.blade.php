...
<div class="px-5">
        ...
        <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            ...
            @foreach ($videos as $video)
                <div class="bg-zinc-950 p-1 rounded-lg">
                    <a href="{{route('video.show', $video)}}" class="relative group">
                        <img src="{{asset('uploads/img').'/'.$video->image}}" alt="imagen del video: {{$video->title}}">
                    ...
                    <div class="grid grid-cols-2 p-3 ">
                        <a href="{{route('dashboard.editVideo.index', $video)}}" class="w-full flex justify-center items-center hover:text-white transition duration-300 text-gray-500 md:text-lg lg:text-xl border-r-2 border-gray-600">
    ...
    @else
        <p class="text-xl p-10 text-center">~ There are no video ~</p>
    @endif
